...
::: {.fragment}
- During boom periods, incomes go up, [aggregate demand rises]{.hp} across consumers

- Some of that spills over into [increased demand for imports]{.hp}
...
Now suppose the [UK sees an economic boom]{.hp}, they increased import of US goods, so the US will hold a higher amount of [GBP reserves]{.hi} 

![](images/exchange-rate-increase-reserves.png){fig-align="center"}
...
![](images/exchange-rate-short-run-fluctuations.png){fig-align="center"}
