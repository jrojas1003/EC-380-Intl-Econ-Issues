...
Some consumers will [switch to domestic goods]{.hp} or [not consume at all]{.hp}
:::
...
- Demand is mapped by the [marginal willingness of individuals to pay]{.h} for a good at a given price
...
- Supply is mapped by the [marginal willingness to receive by producers]{.h} for a good at a given price
...
![](images/market-tariff-large-country.png){fig-align="center"}
...
If $g > b + d$ then the tariff is [welfare enhancing]{.hp}
:::
