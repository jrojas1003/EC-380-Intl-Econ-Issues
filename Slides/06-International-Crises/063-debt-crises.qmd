...
::: {.fragment}
[Spread can end]{.hp} in insolvency, in which other individuals go into bankrupcty because an initial set of individuals do

<br>

What usually happens is the debt gets [restructured]{.hi} which involves lowering the rate of interest, extending the payback period, partial forgiveness, or a combination of them
:::
