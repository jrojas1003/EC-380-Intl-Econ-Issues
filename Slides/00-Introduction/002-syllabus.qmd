...
- If you write your answers on paper and take pictures/scan them, compile them onto [one pdf file]{.h}
    - To do this use any website that merges pdf files (be sure to put them in order!)
    - I personally use [Adobe](https://www.adobe.com/acrobat/online/merge-pdf.html){target="_blank"}
:::
