...
There are [three main reasons]{.h} why economists do [not]{.hp} generally stress the income distribution effect of trade:
...
::: {.fragment}
This rings [somewhat true]{.hp} if we are considering industries. 
...
Imagine a country that [exports high skill-intensive goods]{.h} and [imports low- skill-intensive goods]{.hi}. 
