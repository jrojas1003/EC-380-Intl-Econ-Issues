...
\begin{parts}
    \part[4] What type of activities does the \textbf{capital account} consist of?
    \vspace*{\stretch{1}}
    \part[4] Hoes do the \textbf{current, capital, and financial accounts} relate to one another when it comes to their numeric value?
    \vspace*{\stretch{1}}
    \part[2] Explain the reason why the balance of payments features a \textbf{statistical discrepancy value}.
    \vspace*{\stretch{1}}
\end{parts}
...
\begin{parts}
    \part[2] \textbf{In theory}, what should the \textbf{difference between items (5.a) and (5.b)} be?
    \vspace*{\stretch{1}}
    \part[2] What is the value of \textbf{item (5.a)} equal to? 
    Show your work.
    \vspace*{\stretch{1}}
    \part[2] What is the value of \textbf{item (5.b)} equal to? 
    Show your work.
    \vspace*{\stretch{1}}
    \part[2] What is the value of \textbf{item (4)} in this case?
    \vspace*{\stretch{1}}
    \part[2] Would this country be considered a case of CA surplus or CA deficit?
    \vspace*{\stretch{1}}
\end{parts}
