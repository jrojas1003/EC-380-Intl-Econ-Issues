...
\begin{parts}
    ...
    \vspace*{\stretch{1}}
    \part[5] How do people/labor flows impact trade integration? Why?
    \vspace*{\stretch{1}}
    \part[10] Have trade frictions \textbf{increased or decreased} over time? How does that impact trade flows? 
    \vspace*{\stretch{1}}
\end{parts} 
