...
\begin{parts}
    \part[2] In your own words, how would you define \textbf{Labor Abundance} in the Heckscher-Ohlin model setting?
    \vspace*{\stretch{1}}
    \part[2] How does the capital-labor ratio help us determine patterns of trade?
    \vspace*{\stretch{1}}
    \part[2] Describe the key difference(s) that separate the HO model from the Ricardian model
    \vspace*{\stretch{1}}
    \part[2] Describe the \textbf{Gravity Model}. 
...
\begin{parts}
    \part[2] What are the \textbf{Capital-Labor Ratios} for each country?
    \vspace*{\stretch{1}}
    \part[2] Which country has comparative advantage in producing Ozempic?
    \vspace*{\stretch{1}} 
    \part[2] How will trade flows look once each country specializes?
    \vspace*{\stretch{1}}
\end{parts}
